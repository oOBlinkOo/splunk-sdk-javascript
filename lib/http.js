...
(function() {
    ...
    var queryBuilderMap = {
        "5": function(message) {
            ...
            var post = message.post || {};
             console.log("TYPE111????",post.output_mode);
             console.log("TYPE?222???",query.output_mode);
    ...
    module.exports = root = Http = Class.extend({
        ...
        console.log('object maldito',message)
            ...
            console.log('Url Calling',encodedUrl);
